...
\begin{tikzpicture}
\node[] (a) {\includegraphics[width=1.3in]{longitudinal_45min}};
\node[right=0.4in of a] (b) {\includegraphics[width=0.7in]{DV_45min}};
\draw[->] (a.east) -- (b.west);
\end{tikzpicture}
...
\section{Ordering Images During Cellularization}
...
\section{Ordering Images During Gastrulation}
