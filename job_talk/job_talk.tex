...
Reduction of multiscale data

Want to extract the {\em slow variables}
...
\begin{tikzpicture}
\node[fill=yellow!50, text width=3cm, align=center](a) {$ \frac{dx_1}{dt} = f(x_1,x_2) $ $ \frac{dx_2}{dt} = \frac{1}{\epsilon} g(x_1,x_2)$};
\node[right=of a,fill=yellow!50, text width=3cm, align=center](b) {$ \frac{dx_1}{dt} = f(x_1,\overline{x_2}) $};
...
\begin{tikzpicture}
\node(a) {\includegraphics[width=0.25\textwidth]{data_init}};
\node[right=of a,fill=yellow!50, text width=3cm, align=center](b) {$x_1 $};
