...
\node(stockmarket){\includegraphics[width=1in]{comsol}};
\node[below=0cm of stockmarket, align=center, text width=1.2in]{{\scriptsize Fluid flow \par} };

\node[left=of stockmarket](proteins){\includegraphics[width=1in]{eigengenes}};
\node[below=0cm of proteins, align=center, text width=1.2in]{{\scriptsize Gene expression \par} };
...
\includegraphics[width=\textwidth]{drosophila_live_imaging_ordered}

\vspace{0.1in}

Zebrafish live imaging
\includegraphics[width=\textwidth]{zebrafish_ordered}

\vspace{0.1in}

{\em Drosophila} wing discs (three-dimensional image stacks)
\includegraphics[width=0.5\textwidth]{wing_disc_ordered}
...
\includegraphics[width=2in]{PCA_data}
\includegraphics[width=2in]{PCA_evals}
...
\includegraphics[width=1in]{strip_corr_12}
\includegraphics[width=1in]{strip_corr_13}
\includegraphics[width=1in]{strip_corr_14}
...
\includegraphics[width=1in]{strip_corr_12_fitline}
\includegraphics[width=1in]{strip_corr_13_fitline}
\includegraphics[width=1in]{strip_corr_14_fitline}

\includegraphics[width=1in]{strip_spectrum_L4}
...
\includegraphics[width=1in]{swissroll1}
\includegraphics[width=1in]{swissroll1_color1}
\includegraphics[width=1in]{swissroll1_color2}
\includegraphics[width=1in]{swissroll1_evals}

\includegraphics[width=1in]{swissroll2}
\includegraphics[width=1in]{swissroll2_color1}
\includegraphics[width=1in]{swissroll2_color2}
\includegraphics[width=1in]{swissroll2_evals}
...
\begin{itemize}
\item Cells on a line
\item Randomly turn around at time
\end{itemize}

Important things: $p$ and $t$

Relative importance changes

\includegraphics[width=1in]{hist1_lambda_1}
\includegraphics[width=1in]{hist2_lambda_1}
\includegraphics[width=1in]{hist3_lambda_1}
\includegraphics[width=1in]{hist4_lambda_1}

\includegraphics[width=1in]{hist1_lambda_400}
\includegraphics[width=1in]{hist2_lambda_400}
\includegraphics[width=1in]{hist3_lambda_400}
\includegraphics[width=1in]{hist4_lambda_400}
...
\includegraphics[width=1in]{EMD_withhist_p_1}
\includegraphics[width=1in]{EMD_withhist_t_1}

\includegraphics[width=1in]{EMD_withhist_p_400}
\includegraphics[width=1in]{EMD_withhist_t_400}
...
\includegraphics[width=1in]{chemotaxis1_evals}
\includegraphics[width=1in]{chemotaxis1_embed_good}

\includegraphics[width=1in]{chemotaxis2_evals}
\includegraphics[width=1in]{chemotaxis2_embed_good}


\includegraphics[width=1in]{chemotaxis3_evals}
\includegraphics[width=1in]{chemotaxis3_embed_good}
...
\includegraphics[width=2in]{tmax_lambda_transition}
