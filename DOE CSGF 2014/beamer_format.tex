...
%\usepackage{extsizes}
\setbeamerfont{footnote}{size=\fontsize{5}{0.25}}
\setbeamerfont{footnote mark}{size=\fontsize{5}{0.25}}

\usepackage[firstinits=true,style=verbose,maxnames=6,backend=bibtex]{biblatex}
\renewbibmacro{in:}{}
\bibliography{../../Stas_data/image_analysis_paper/background_reading/references,../../references/references}
...
%\renewcommand\footnote[2][]{{\linespread{0.2}\oldfootnote[#1]{#2}}}
