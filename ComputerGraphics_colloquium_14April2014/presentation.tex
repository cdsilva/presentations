...
\begin{tikzpicture}
\node(a) {\includegraphics[width=0.3\textwidth]{images_angsynch}};

\node[below=0in of a, align=center, text width=0.3\textwidth](text) {Images, registered using angular synchronization};

\node[right=0.15\textwidth of a] (b) {\includegraphics[width=0.3\textwidth]{images_dmaps}};

\node[below=0in of b, align=center, text width=0.3\textwidth](text) {Images, registered using angular synchronization and temporally ordered using diffusion maps};
