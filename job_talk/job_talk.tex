...
\author{Carmeline J. Dsilva \\ {\scriptsize Joint work with Ronen Talmon, Ronald Coifman, and Yannis Kevrekidis}}
...
\node[right=of a,fill=yellow!20, text width=3cm, align=center](b) {$ \frac{dx_1}{dt} = f(x_1,\hat{x_2}(x_1)) $};
...
\begin{frame}{Alanine Dipeptide Simulations}
    ...
    \begin{minipage}[t]{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../NLICA/paper/FES}\\
        {\small The free energy surface (FES) of Ala2 has three distinct wells}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.4\textwidth}
        \centering
        \includegraphics[width=0.6\textwidth]{../NLICA/paper/molecule2}\\
...
\begin{frame}{NIV Embeddings}
    \begin{minipage}[t]{0.45\textwidth}
        \centering
        \includegraphics[width=0.5\textwidth, trim=0in 0.2in 0in 0.2in, clip]{../DOE_CSGF_2013/molecule_all}\\
        {\small In one data set, we observe all the atoms in the molecule \par}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.45\textwidth}
        \centering
        \includegraphics[width=0.5\textwidth, trim=0in 0.2in 0in 0.2in, clip]{../DOE_CSGF_2013/molecule_odd}\\
    ...
    \begin{minipage}{0.2\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../NLICA/paper/ala_figures_allodd/ala2_embed1}\\
        (a)
    \end{minipage}
%    \hfill
    \begin{minipage}{0.2\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../NLICA/paper/ala_figures_allodd/ala2_embed2}\\
        (b)
    \end{minipage}
%    \hfill
    \begin{minipage}{0.2\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../NLICA/paper/ala_figures_allodd/ala2_embed3}\\
        (c)
    \end{minipage}\\
...
\begin{frame}{Reconstructions of Molecular Configurations}
	...
	\centering
	\includegraphics[width=0.25\textwidth,trim=0in 5in 0in 0in, clip]{../NLICA/paper/molec_figures/molecule300_balls}
	\hspace{0.05\textwidth}
	\includegraphics[width=0.25\textwidth,trim=0in 5in 0in 0in, clip]{../NLICA/paper/molec_figures/molecule600_balls}
	\hspace{0.05\textwidth}
	\includegraphics[width=0.25\textwidth,trim=0in 5in 0in 0in, clip]{../NLICA/paper/molec_figures/molecule900_balls}\\
...
\begin{frame}{Another Story: Ordering Images}
